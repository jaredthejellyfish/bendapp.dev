...
const FAQ = () => {
  ...
  return (
    <div className="relative py-16">
      {/* Background effect */}
      <div className="absolute top-1/2 left-1/4 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-[#FF333D]/5 blur-[100px] opacity-30 -z-10" />
        ...
        <div className="space-y-4">
          {faqItems.map((item, index) => (
            ...
            >
              ...
              >
                <div className="p-6 pt-0 text-white/70">{item.answer}</div>
              </motion.div>
            </motion.div>
          ))}
        </div>
