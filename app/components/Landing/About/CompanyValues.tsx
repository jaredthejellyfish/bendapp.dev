...
const CompanyValues = () => {
  ...
  return (
    <div className="relative py-16">
      ...
      <div className="absolute -right-64 top-1/3 w-[500px] h-[500px] rounded-full bg-primary/5 blur-[120px] opacity-40" />
      <div className="absolute -left-64 bottom-1/3 w-[400px] h-[400px] rounded-full bg-primary/5 blur-[100px] opacity-30" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-border/10 flex flex-col"
            >
              <motion.div
                ...
                viewport={{ once: true }}
                className="mb-6 bg-background/5 rounded-lg p-3 w-fit"
              >
                {value.icon}
              </motion.div>
