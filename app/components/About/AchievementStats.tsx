  ...
  return (
    <div ref={containerRef} className="relative py-16">
      ...
      <div className="absolute w-full h-full overflow-hidden">
        <div className="absolute left-1/4 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-[#FF333D]/10 blur-[100px] opacity-40" />
        <div className="absolute right-1/4 top-1/2 transform translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-[#FF333D]/10 blur-[100px] opacity-40" />
      </div>
